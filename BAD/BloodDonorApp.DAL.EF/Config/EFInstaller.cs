...
namespace BloodDonorApp.DAL.EF.Config
{
    public class EFInstaller : IWindsorInstaller
    {
        ...
        internal const string ConnectionString = "Data source=blooddonorapp.database.windows.net;Database=BLOODDONORAPP-DB;User ID=dBloodAdmin;Password=dBlood2019;Trusted_Connection=False;Encrypt=True;MultipleActiveResultSets=true";
